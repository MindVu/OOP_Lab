...
public class CartScreenController {
    ...
    private void initialize() {
        ...
        tblMedia.getSelectionModel().selectedItemProperty().addListener(
                new ChangeListener<Media>() {
                    ...
                    private void updateButton(Media media) {
    ...
    void btnOrderPressed(ActionEvent event) {
        if (cart.getItemsOrdered().size() > 0) {
            ...
            Alert alert = new Alert(Alert.AlertType.WARNING, "Order something first", ButtonType.OK);
            alert.setTitle("Order");
            alert.setHeaderText(null);
            alert.showAndWait();
        }
    ...
    void btnPlayPressed(ActionEvent event) {
        ...
        Alert alert = new Alert(Alert.AlertType.NONE, "Now playing: " + media.getTitle(), ButtonType.OK);
